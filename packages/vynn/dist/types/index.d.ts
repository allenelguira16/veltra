...
declare function renderToString(App: () => JSX.Element): JSX.Element;

export { JSX, Portal, Suspense, computed, createApp, createContext, effect, hydrateApp, lazy, loop, memo, onDestroy, onMount, renderToString, resource, state, stopEffect, store, untrack, unwrap };
