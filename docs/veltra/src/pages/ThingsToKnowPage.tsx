...
export const ThingsToKnowPage = () => {
  return (
    <div>
      ...
      <section>
        <p>
          Before diving deeper into Veltra, it's important to understand some core concepts that
          differentiate it from React or other frameworks you might be familiar with. These insights
          will help you build better, more efficient apps with Veltra's reactivity system.
        </p>
        ...
        />
        <p>
          However, this pattern won't work in Veltra. Unlike React, components in Veltra don't rerun
          when state changes. Veltra directly updates the DOM based on reactivity, so any
          conditional rendering must live inside JSX itself.
        </p>
        <p>Here's the correct way to conditionally render in Veltra:</p>
        <CodeBlock
          lang="tsx"
          code={`
            import { state } from "@veltra/app";
        ...
        />
        <p>
          While this works, Veltra provides a more efficient alternative with <code>loop</code>,
        ...
        <CodeBlock
          lang="tsx"
          code={`
            import { state, loop } from "@veltra/app";
        ...
        <p>
          In Veltra, when you pass children to a component, the children are always passed as
        ...
        />
        <p>
          Veltra's rendering is parent-first — meaning the parent renders before its children are
        ...
        <h2 class="mt-6">TLDR: Veltra's Mindset Shift</h2>
        ...
        <p class="mt-4">
          By keeping these principles in mind, you'll write Veltra apps that are not only performant
