    ...
    <div>
      ...
      <section>
        ...
        <CodeBlock
          lang="tsx"
          code={`
            import { createApp, state, effect } from "@veltra/app";
        ...
        <p>
          You can also use <code>async</code> functions inside <code>effect</code>. Veltra will wait
        ...
        <p>
          ...
          listener), you can return a function from <code>effect</code>. Veltra will call it before
