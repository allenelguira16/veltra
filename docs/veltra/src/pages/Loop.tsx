...
export const Loop = () => {
  return (
    <div>
      ...
      <section>
        <p>
          <code>loop()</code> is Veltra's fine-grained, keyed list renderer. It lets you iterate
          over an array of items and efficiently render components with preserved internal state.
        </p>
        <p>
        ...
        <CodeBlock
          lang="tsx"
          code={`
            import { loop, state } from "@veltra/app";
