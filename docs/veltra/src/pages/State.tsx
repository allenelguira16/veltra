...
export const State = () => {
  return (
    <div>
      ...
      <section>
        <p>
          <code>state()</code> is a primitive reactive signal in Veltra. It holds a mutable value
          and automatically tracks reads and writes to re-run the DOM or any <code>effect()</code>{" "}
          that depends on it.
        </p>
...
createApp(Counter).mount("#app");`}
        ...
        <ul>
          <li>
            When you read <code>state.value</code> inside JSX or <code>effect()</code>, Veltra
            tracks the access.
          </li>
          <li>
