...
export const InstallationPage = () => {
  return (
    <div>
      ...
      <section>
        <h2>Installing @vynn/core</h2>
        <CodeBlock
          lang="bash"
          code={`yarn add "@vynn/core@git+https://github.com/allenelguira16/vynn.git#workspace=@vynn/core"`}
        />
        ...
        <p>
          ...
          config in tsconfig.json so it will use the @vynn/core JSX runtime
        </p>
        <CodeBlock
          lang="json5"
          code={`
