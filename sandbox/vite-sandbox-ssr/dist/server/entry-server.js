  ...
  function renderRecursive(value) {
    ...
    for (const child of children2) {
      ...
      if (typeof child === "function") {
        ...
        const resolved = getNode$1(child);
...
function h$1(type, props, children) {
  ...
  return `<${type}${applyProps$1(props)}>${renderChildrenToString(children)}</${type}>`;
}
...
function serverRenderedDOM() {
  return {
    ...
    get currentTextNode() {
      const dom = renderedText[currentTextNodeIndex];
      if (!dom) return void 0;
      for (let j = 0; j < dom.childNodes.length; j++) {
        dom.childNodes[j];
      }
    ...
    nextTextNode: () => currentTextNodeIndex++
  };
}
...
function state(initialValue) {
  if (isServer) return deepProxyFreeze({
    value: initialValue
  });
...
function Suspense(props) {
  ...
  const fallback = () => isServer ? _fallback : _fallback == null ? void 0 : _fallback();
  const {
    currentDOM
  } = serverRenderedDOM();
  ...
  const handler = (promise) => {
    ...
    currentDOM == null ? void 0 : currentDOM.remove();
    queueMicrotask(() => {
      view.value = fallback();
    });
    promise.then(() => {
...
function renderChildren(parentNode, children, baseAnchor = null) {
  const cleanups = [];
  const anchorNodes = /* @__PURE__ */ new WeakSet();
      ...
      try {
        ...
        for (const child of children2) {
          ...
          if (typeof child === "function") {
            ...
            anchorNodes.add(childAnchor);
            if (anchor) anchorNodes.add(anchor);
...
function store(initialObject) {
  if (isServer) return deepProxyFreeze(initialObject);
...
function App() {
  ...
  return () => jsx("div", {
    ...
    children: () => [() => jsx("div", {
      ...
      class: () => "p-2 w-full",
      children: () => jsx(Contexts, {})
    }), () => jsx("div", {
      class: () => "p-2 w-full",
      children: () => jsx(Dropdowns, {})
    }), () => jsx("div", {
      class: () => "p-2 w-full",
      children: () => jsx(StackedSuspense, {})
    }), () => jsx("div", {
      class: () => "p-2 w-full",
      children: () => jsx(PokeDex, {})
    }), () => jsx("div", {
      class: () => "p-2 w-full",
      children: () => jsx(PokeDexSuspense, {})
    })]
  });
}
const render = () => {
